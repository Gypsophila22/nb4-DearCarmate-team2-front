...
export const getServerSideProps = (async ({ query }) => {
  const { searchBy: searchByParam, keyword: keywordParam } = query;
  const searchBy =
    SearchByContract[searchByParam as keyof typeof SearchByContract] ||
    SearchByContract["customerName"];
