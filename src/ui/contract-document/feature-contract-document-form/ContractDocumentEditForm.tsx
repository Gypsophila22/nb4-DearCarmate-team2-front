...
const ContractDocumentEditForm = ({
  initialDocuments,
  onClose,
  onSubmit,
}: ContractDocumentEditFormProps) => {
  const methods = useForm<ContractDocumentEditFormInput>({
    defaultValues: { contractDocuments: initialDocuments },
  });
