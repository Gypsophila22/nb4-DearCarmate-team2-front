  ...
  return (
    <div className={cx("container")}>
        ...
        <div className={cx("body")}>
          <div className={cx("compared")}>
            <div className={cx("growthRate")}>
              <Icon
                name={growthRate > 0 ? "arrow-up-red" : "arrow-down-blue"}
                width={18}
                height={18}
              />
              <div className={cx("value", { isIncreased: growthRate > 0 })}>
                {Math.abs(growthRate).toLocaleString(undefined, {
                  style: "percent",
      ...
      <div className={cx("item")}>
        ...
        <div className={cx("body")}>
          <div className={cx("compared")} />
          <div className={cx("present")}>{proceedingContractsCount}건</div>
        </div>
      </div>
      <div className={cx("item", "last")}>
        ...
        <div className={cx("body")}>
          <div className={cx("compared")} />
          <div className={cx("present")}>{completedContractsCount}건</div>
        </div>
      </div>
    </div>
  );
